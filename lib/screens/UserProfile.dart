                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                            children: [
                              SizedBox(child: Text("${userDetails['email']}", style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.black87, fontSize: 20), overflow: TextOverflow.ellipsis,)),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                            children: [
                              SizedBox(child: Text("${userDetails['password']}", style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.black87, fontSize: 20), overflow: TextOverflow.ellipsis,)),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                          SizedBox(child: Text("${userDetails['university']}", style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.black87, fontSize: 20), overflow: TextOverflow.ellipsis,)),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                            children: [
                              SizedBox(child: Text("${userDetails['degree']}", style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.black87, fontSize: 20), overflow: TextOverflow.ellipsis,)),
